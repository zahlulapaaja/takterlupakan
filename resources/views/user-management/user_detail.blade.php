            ...
            <div class="card mb-5 mb-xl-8">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex flex-center flex-column py-5">
                        ...
                        <!--end::Avatar-->
                        <!--begin::Name-->
                        <a href="#" class="fs-3 text-gray-800 text-hover-primary fw-bold mb-3">{{ $data->name }}</a>
                        <!--end::Name-->
                        <!--begin::Position-->
                        <div class="mb-9">
                            <!--begin::Badge-->
                    ...
                    <div id="kt_user_view_details" class="collapse show">
                        <div class="pb-5 fs-6">
                            ...
                            <div class="text-gray-600">25 Jul 2023, 6:05 pm</div>
                            <!--begin::Details item-->
                        </div>
                    </div>
                    <!--end::Details content-->
                                ...
                                <table class="table align-middle table-row-dashed fw-semibold text-gray-600 fs-6 gy-5" id="kt_table_users_logs">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>POST /v1/invoice/in_2370_6784/invalid</td>
                                        ...
                                        <tr>
                                            ...
                                            <td>POST /v1/invoice/in_7727_6876/invalid</td>
                                        ...
                                        <tr>
                                            ...
                                            <td>POST /v1/invoices/in_8673_3703/payment</td>
                                        ...
                                        <tr>
                                            ...
                                            <td>POST /v1/invoices/in_5617_5056/payment</td>
