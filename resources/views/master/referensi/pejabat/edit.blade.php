<x-default-layout>
    ...
    @section('breadcrumbs')
    {{ Breadcrumbs::render('master.pejabat.edit', $data->id) }}
    @endsection
    ...
    <div class="card mb-5 mb-xl-8">
        ...
        <div class="card-header border-0 pt-5">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label fw-bold fs-3 mb-1">Edit Pejabat</span>
        ...
        <div class="card-body pt-8">
            <!--begin::Form-->
            <form class="form" action="{{ route('master.pejabat.update', $data->id) }}" method="post">
                @csrf
                @method('PUT')
                <!--begin::Input group-->
                ...
                <div class="d-flex flex-row mb-7 fv-row">
                    <div class="d-flex flex-column w-1/2 mr-7">
                        ...
                        <input name="tgl_mulai" type="date" class="form-control form-control-solid" placeholder="00/00/0000" value="{{$data->tgl_mulai}}" required />
                    </div>
                    <div class="d-flex flex-column w-1/2 fv-row">
                        <label class="d-flex align-items-center fs-6 fw-semibold form-label mb-2">
                            <span>Tanggal Selesai</span>
                        </label>
                        <input name="tgl_selesai" type="date" class="form-control form-control-solid" placeholder="00/00/0000" value="{{$data->tgl_selesai}}" />
                    </div>
                </div>
                <!--end::Input group-->
                <!--begin::Input group-->
                <div class="d-flex flex-row mb-7 fv-row">
                    <div class="d-flex flex-column w-1/2 mr-7">
                        ...
                        <input name="no_sk" type="text" class="form-control form-control-solid" placeholder="Masukkan Nomor SK..." value="{{$data->no_sk}}" />
                    </div>
                    <div class="d-flex flex-column w-1/2 fv-row">
                        <label class="d-flex align-items-center fs-6 fw-semibold form-label mb-2">
                            <span>Tanggal SK</span>
                        </label>
                        <input name="tgl_sk" type="date" class="form-control form-control-solid" placeholder="00/00/0000" value="{{$data->tgl_sk}}" />
                    </div>
                </div>
                <!--end::Input group-->
                <!--begin::Actions-->
